...
KM: Here we are trying to reproduce the analyses using two data files provided by the authors after asking for their assistance. 
...
NB: after author assistance we now have 102 trials for each participant. 
...
So we filter out participants who did not make any incorrect classifications for either the good or bad face types. We expect that: $N_{bad} = 126 = 169 - 43$ and $N_{good} = 138 = 169 - 31$
